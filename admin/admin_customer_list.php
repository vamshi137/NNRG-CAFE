...
<<<<<<< HEAD
                    ...
                    <td><?php 
                        if(!empty($row["c_department"])){
                            // Display department/stream in a more readable format
                            switch($row["c_department"]){
                                case "BTECH": echo "B.Tech"; break;
                                case "MBA": echo "MBA"; break;
                                case "PHARMACY": echo "Pharmacy"; break;
                                case "MTECH": echo "M.Tech"; break;
                                case "CSE": echo "Computer Science"; break;
                                case "ECE": echo "Electronics & Communication"; break;
                                case "EEE": echo "Electrical & Electronics"; break;
                                case "MECH": echo "Mechanical Engineering"; break;
                                case "CIVIL": echo "Civil Engineering"; break;
                                case "CHEM": echo "Chemical Engineering"; break;
                                case "MATHEMATICS": echo "Mathematics"; break;
                                case "PHYSICS": echo "Physics"; break;
                                case "CHEMISTRY": echo "Chemistry"; break;
                                case "ENGLISH": echo "English"; break;
                                case "ECONOMICS": echo "Economics"; break;
                                case "COMMERCE": echo "Commerce"; break;
                                case "ADMINISTRATION": echo "Administration"; break;
                                default: echo $row["c_department"];
                            }
                        } else {
                            echo "N/A";
                        }
